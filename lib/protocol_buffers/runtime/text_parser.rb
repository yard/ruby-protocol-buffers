...
racc_action_table = [
     2,     6,     6,    10,     6,    11,    23,    24,    29,     8,
     9,     7,     7,    30,     7,    15,    20,    17,    19,    18,
    13,    25,    28 ]

racc_action_check = [
     1,    26,     1,     5,    27,     5,    12,    12,    26,     2,
     4,    26,     1,    27,    27,     9,     9,     9,     9,     9,
     7,    16,    24 ]

racc_action_pointer = [
   nil,     0,     9,   nil,     3,    -5,   nil,    18,   nil,    13,
   nil,   nil,    -7,   nil,   nil,   nil,    18,   nil,   nil,   nil,
   nil,   nil,   nil,   nil,    20,   nil,    -1,     2,   nil,   nil,
   nil ]
